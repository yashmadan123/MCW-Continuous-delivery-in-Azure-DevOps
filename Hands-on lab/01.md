...
12. The above steps automated building and updating only one of the Docker images. The next steps, we will update the workflow file with a more appropriate workflow for the structure of our repository. This task will end with a file named `docker-publish.yml` that will rebuild and publish Docker images as their respective code is updated.

13. Locally, Pull the changes from your repository to your copy of the code. 

    ```
    git pull
    ```

14. Copy `docker-publish.yml` from the `Hands-on lab\lab-files` folder to the `.github\workflows` folder, and remove the file `fabrikam-web.yml`  you created in steps 1-5.
...
15. Commit and push your changes to your GitHub repository by running the following commands.
