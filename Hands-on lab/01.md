...
15. Change the image name to `fabrikam-web` (Line 22) and the registry to `docker.pkg.github.com/<githubaccountname>/<githubreponame>` (Line 20). This is the name of the container image that will be pushed to the GitHub Container Registry.
