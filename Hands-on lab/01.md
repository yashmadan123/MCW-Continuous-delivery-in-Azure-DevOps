...
4. Now in PowerShell build and run the docker-compose YAML files edited in the previous step by running the following command. After 10-15 min, proceed with the next step to check if you are able to see the website.
