...
1. minimize the Docker Desktop application
...
1. You should arrive at the `Security & analysis` blade under the `Settings` tab. Enable `Dependabot alerts` and `Dependabot security updates`.
...
You should follow all above steps provided *before* performing the Hands-on lab.
