...
1. In a new browser tab open ```https://www.github.com``` and log in to the GitHub account using credentails from **Environment Details** page.
...
3. Select the existing organization named aiw-devops and select **Fabrikam-<inject key="DeploymentID" enableCopy="false" />** project.
