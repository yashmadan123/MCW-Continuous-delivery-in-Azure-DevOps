...
5. Browse to the `Overview` blade of the Azure Web Application detail page and find the web application URL. Browse to that URL to verify deployment of the web application. It might take few minutes for the web application to relect new changes.
